...
@Controller
@RequestMapping("/localowners-bs")	// GET y POST
@SessionAttributes("{localowner}")
public class LocalOwnerBsController {
	...
	public String newLocalOwner(Model model) {
		...
		return "localowners-bs/new-localowner";
	}
	...
	public String listLocalOwners(Model model) {
		...
		return "localowners-bs/list-localowners";
	}
	...
	public String editLocalOwner(Model model, @PathVariable("id") Integer id) {				
		...
		return "localowners-bs/edit-localowner";
	}
